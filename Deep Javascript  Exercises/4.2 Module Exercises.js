// en este ejercicio el objetivo es refactorizar el codigo
//  que hemos usado en el curso usando el patro de diseno modular
...
// ********************************
//  deefinimos el modulo factory

// organizamos las funciones en una sola
function defineWorkshop() {
  var currentEnrollment = [];
  var studentRecords = [];

  var publicAPI = {
    // creamos la api publica que contenera todas las funciones
    addStudent,
    enrollStudent,
